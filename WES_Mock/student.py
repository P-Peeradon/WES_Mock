...
class Student():
    ...
    def __init__(self, id: str = "00000000", fname: str = "no name", lname: str = "no surname", date_of_birth: date = date(2000, 1, 1), program: str = "unknown", phone: str = "03XXXXXXXX", email: str = "XXX@hotmail.com", address: str = "unknown"):
        self.__id = id
        self.__fname = fname
        self.__lname = lname
